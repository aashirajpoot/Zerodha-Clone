...
function ProductsPage() {
    return ( 
        <>
            ...
            <p className='fs-5 text-center mt-5'>Want to know more about our technology stack? Check out the <Link to="#" style={{textDecoration:"none"}}>Zerodha.tech</Link> blog.</p>
