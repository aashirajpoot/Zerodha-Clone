        ...
        <footer style={{backgroundColor:"rgb(240, 240, 240)"}}>
            <div className='container p-3 mt-5 border-top'>
                <div className='row mt-5'>
                    <div className='col'>
                        <img src='media/images/logo.svg' alt='logo' style={{width:"10rem"}} className='mb-3'/>
                        <p className='foot'>
                    ...
                    <div className='col'>
                        <h3 className='fs-5'>Account</h3>
                            ...
                            <a href='' style={{textDecoration:"none", color:"grey"}}>HUF demat account</a> <br/>
                            ...
                            <a href='' style={{textDecoration:"none", color:"grey"}}>MTF</a>
                    </div>
                    <div className='col'>
                        ...
                        <a href='' style={{textDecoration:"none", color:"grey"}}>Contact us</a> <br/>
                            ...
                            <a href='' style={{textDecoration:"none", color:"grey"}}>Downloads</a>
                    </div>
                    <div className='col'>
                        ...
                        <a href='' style={{textDecoration:"none", color:"grey"}}>About</a> <br/>
                            ...
                            <a href='' style={{textDecoration:"none", color:"grey"}}>Referral program</a>
                    </div>
                    <div className='col'>
                        ...
                        <a href='' style={{textDecoration:"none", color:"grey"}}>Upcoming IPOs</a> <br/>
                            ...
                            <a href='' style={{textDecoration:"none", color:"grey"}}>Gift Nifty</a>
                    </div>

                    <div className='text-muted foot-text mt-5'>
                        <p>
                    ...
                    <ul className=' d-flex flex-wrap justify-content-center gap-4 pb-4 mt-4 text-muted'>
                        ...
                        <a href='' style={{textDecoration:"none", color:"grey"}}>MSEI</a>
                        ...
                        <a href='' style={{textDecoration:"none", color:"grey"}}>Investor charter Sitemap</a>
